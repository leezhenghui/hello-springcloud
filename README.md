...
Requests/sec:     49.72
```
The `nmon` command running in background to do the sampling, the overall system performance analysis result is:

[nmon result](./docs/hello-springcloud_180918_0439.nmon.xlsx)
